# graph-mail-calendar-mcp

Model Context Protocol (MCP) Server for the *graph-mail-calendar-mcp* API.

<div align="left" style="margin-bottom: 0;">
    <a href="https://www.speakeasy.com/?utm_source=graph-mail-calendar-mcp&utm_campaign=mcp-typescript" class="badge-link">
...
<br /><br />
> [!IMPORTANT]
> This MCP Server is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/tacerto/tacerto). Delete this notice before publishing to a package manager.

<!-- Start Summary [summary] -->
## Summary

Microsoft Graph (Pruned) - Mail & Calendar: Minimal OpenAPI spec covering core Mail and Calendar endpoints for use with MCP builders like Gram.
<!-- End Summary [summary] -->

<!-- Start Table of Contents [toc] -->
## Table of Contents
<!-- $toc-max-depth=2 -->
* [graph-mail-calendar-mcp](#graph-mail-calendar-mcp)
...
[![Install MCP Server](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/install-mcp?name=GraphMailCalendarSDK&config=eyJtY3BTZXJ2ZXJzIjp7IkdyYXBoTWFpbENhbGVuZGFyU0RLIjp7ImNvbW1hbmQiOiJucHgiLCJhcmdzIjpbImdyYXBoLW1haWwtY2FsZW5kYXItbWNwIiwic3RhcnQiLCItLW9hdXRoMiIsIi4uLiJdfX19)
...
```bash
claude mcp add graph-mail-calendar-mcp npx graph-mail-calendar-mcp start -- --oauth2 ...
```
...
```bash
npx graph-mail-calendar-mcp start --oauth2 ...
```

For a full list of server arguments, run:

```
npx graph-mail-calendar-mcp --help
```
...
2. Run `npm install`
3. Run `npm run build`
4. Run `node ./bin/mcp-server.js start --oauth2 ...`
...
```bash
npx @modelcontextprotocol/inspector node ./bin/mcp-server.js start --oauth2 ...
```
...
### MCP Server Created by [Speakeasy](https://www.speakeasy.com/?utm_source=graph-mail-calendar-mcp&utm_campaign=mcp-typescript)
